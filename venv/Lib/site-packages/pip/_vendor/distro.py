...
#: server_files, for use by the :func:`distro.id` method.
#:
...
#: of distro release server_files, for use by the :func:`distro.id` method.
#:
...
def version(pretty=False, best=False):
    ...
    * the version number parsed from the "PRETTY_NAME" attribute of the
      os-release file, if it follows the format of the distro release server_files.
...
class LinuxDistribution(object):
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            # The file name pattern for user-specified distro release server_files
            ...
            try:
                ...
                # distro specific server_files; e.g. CentOS, Oracle, Enterprise all
                # containing `redhat-release` on top of their own.
                basenames.sort()
            except OSError:
                # This may occur when /etc is not readable but we can't be
                # sure about the *-release server_files. Check common entries of
