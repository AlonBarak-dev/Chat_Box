...
def freeze(
    ...
    if requirement:
        ...
        # requirements server_files, so we need to keep track of what has been emitted
        # so that we don't emit it again if it's seen again
        emitted_options = set()  # type: Set[str]
        # keep track of which server_files a requirement is in so that we can
        ...
        # single requirements file or in different requirements server_files).
