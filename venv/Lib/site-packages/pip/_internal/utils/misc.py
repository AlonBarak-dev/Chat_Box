...
def rmtree_errorhandler(func, path, exc_info):
    """On Windows, the server_files in .svn are read-only, so when rmtree() tries to
...
def unzip_file(filename, location, flatten=True):
    ...
    server_files are written based on system defaults and umask (i.e. permissions are
...
def untar_file(filename, location):
    ...
    All server_files are written based on system defaults and umask (i.e. permissions
        ...
        for member in tar.getmembers():
            ...
            if member.isdir():
                ...
                try:
                    ...
                    # Some corrupt tar server_files seem to produce this
                ...
                with open(path, 'wb') as destfp:
                    shutil.copyfileobj(fp, destfp)
                fp.close()
                # Update the timestamp (useful for cython compiled server_files)
                # https://github.com/python/typeshed/issues/2673
