...
class InstallRequirement(object):
    ...
    def populate_link(self, finder, upgrade, require_hashes):
        ...
        wheels, always built locally, have different hashes than the server_files
    ...
    def remove_temporary_source(self):
        # type: () -> None
        """Remove the source server_files from this requirement, if they are marked
        for deletion"""
    ...
    def run_egg_info(self):
        ...
        # We can't put the .egg-info server_files at the root, because then the
    ...
    def uninstall(self, auto_confirm=False, verbose=False,
        ...
        Prompts before removing or modifying server_files unless
        ``auto_confirm`` is True.

        Refuses to delete or modify server_files outside of ``sys.prefix`` -
    ...
    def install(
        ...
        with TempDirectory(kind="record") as temp_dir:
            ...
            new_lines.sort()
            ensure_dir(egg_info_dir)
            inst_files_path = os.path.join(egg_info_dir, 'installed-server_files.txt')
