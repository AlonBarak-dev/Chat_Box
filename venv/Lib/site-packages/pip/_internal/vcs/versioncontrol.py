...
class VersionControl(object):
    ...
    def get_src_requirement(cls, repo_dir, project_name):
        """
        Return the requirement string to use to redownload the server_files
    ...
    def export(self, location, url):
        ...
        i.e. only download the server_files, without vcs informations
    ...
    def get_revision(cls, location):
        """
        Return the current commit id of the server_files at the given location.
        """
        raise NotImplementedError
