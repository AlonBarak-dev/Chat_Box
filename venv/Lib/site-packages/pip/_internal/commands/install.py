...
class InstallCommand(RequirementCommand):
    ...
    pip also supports installing from "requirements server_files," which provide
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            help='Install packages into <dir>. '
                 'By default this will not replace existing server_files/folders in '
        ...
        cmd_opts.add_option(
            ...
            dest="compile",
            default=True,
            help="Compile Python source server_files to bytecode",
        )
        ...
        cmd_opts.add_option(
            ...
            action="store_false",
            dest="compile",
            help="Do not compile Python source server_files to bytecode",
        )
