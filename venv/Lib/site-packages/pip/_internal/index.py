...
class LinkEvaluator(object):
    ...
    def __init__(
        ...
        :param allow_yanked: Whether server_files marked as yanked (in the sense
...
class PackageFinder(object):
    ...
    def _sort_locations(locations, expand_dir=False):
        ...
        """
        Sort locations into "server_files" (archives) and "urls", and return
        a pair of lists (server_files,urls)
        """
        files = []
        urls = []
    ...
    def find_all_candidates(self, project_name):
        ...
        See LinkEvaluator.evaluate_link() for details on which server_files
        are accepted.
        """
