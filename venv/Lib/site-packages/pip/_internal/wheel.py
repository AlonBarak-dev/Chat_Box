...
def get_entrypoints(filename):
    ...
    # means that they may or may not be valid INI server_files. The attempt here is to
...
def move_wheel_files(
    ...
    # Record details of the server_files moved
    #   installed = server_files copied from the wheel to the destination
    #   changed = server_files changed while installing (scripts #! line typically)
    #   generated = server_files newly generated during the install (script wrappers)
    installed = {}  # type: Dict[str, str]
    changed = set()
    generated = []  # type: List[str]

    # Compile all of the pyc server_files that we're going to be installing
    if pycompile:
...
"""
    ...
    # Record details of all server_files installed
...
def get_legacy_build_wheel_path(
    ...
    if not names:
        msg = (
            'Legacy build of wheel for {!r} created no server_files.\n'
        ).format(req.name)
